...
extern NSString *const TUP_CALL_INFO_KEY;               // CallInfo
extern NSString *const TUP_CALL_RINGBACK_KEY;           // value: BOOL , is play media
...
extern NSString *const VCCONF_ATTENDEE_UPDATE_KEY ;
...
typedef enum
{
    ...
    CONF_E_BROADCAST_RESULT,
    CONF_E_CANCEL_BROADCAST_RESULT,
    CONF_E_WATCH_RESULT,
}EC_CONF_E_TYPE;
...
typedef NS_ENUM(NSUInteger, VC_ATTENDEE_UPDATE_E) {
    VC_ATTENDEE_UPDATE_JOIN = 0,
    VC_ATTENDEE_UPDATE_LEAVE,
    VC_ATTENDEE_UPDATE_ADD,
    VC_ATTENDEE_UPDATE_DEL,
    VC_ATTENDEE_UPDATE_MUTE,
    VC_ATTENDEE_UPDATE_MUTE_ALL = 5,
    VC_ATTENDEE_UPDATE_UNMUTE_ALL,
    VC_ATTENDEE_UPDATE_NAME,
    VC_ATTENDEE_UPDATE_PSTN,
    VC_ATTENDEE_UPDATE_LOCAL_MUTE,
