...
static void PrintReachabilityFlags(SCNetworkReachabilityFlags flags, const char* comment)
{
    ...
    NSLog(@"VCReachability Flag Status: %c%c %c%c%c%c%c%c%c %s\n",
...
#pragma unused (target, flags)
	...
	NSCAssert([(__bridge NSObject*) info isKindOfClass: [VCReachability class]], @"info was wrong class in ReachabilityCallback");

    VCReachability* noteObject = (__bridge VCReachability *)info;
    // Post a notification to notify the client that the network reachability changed.
    [[NSNotificationCenter defaultCenter] postNotificationName: kReachabilityChangedNotification object: noteObject];
}


#pragma mark - VCReachability implementation

@implementation VCReachability
{
...
{
	VCReachability* returnValue = NULL;
