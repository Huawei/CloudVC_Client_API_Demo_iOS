...
@interface ConfChatViewController ()<DataConferenceChatMessageDelegate, UITextFieldDelegate>
...
- (void)viewDidLoad {
    ...
    [super viewDidLoad];
    [ManagerService dataConfService].chatDelegate = self;
...
- (IBAction)sendMessage:(id)sender
{
    ...
    if ([[ManagerService dataConfService] chatSendMsg:_chatTextField.text fromUsername:_selfInfo.aucName toUserId:0]) {
        _chatTextField.text = @"";
    }
}
